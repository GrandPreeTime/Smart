...
public class sms_email extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState){
            ...
            fourth_num.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    ...
                    if (CorVal != ResVal) {
                        FCode = "";
                        Toast errorToast = Toast.makeText(sms_email.this, "Введен неправильный код!", Toast.LENGTH_SHORT);
                        errorToast.show();
                    } else if (CorVal == ResVal) {
                        Intent intent = new Intent(sms_email.this, create_parol.class);
        ...
        public void onClick (View view){
            if (CorVal == ResVal) {
                Intent intent = new Intent(this, create_parol.class);
                startActivity(intent);
            } else {
