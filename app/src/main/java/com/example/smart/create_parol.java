...
public class create_parol extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final String APP_PREFERENCES_CARD_FINISH = "skip_passcode";

    ImageView ind_1st, ind_2nd, ind_3rd, ind_4th;

    Button rb0, rb1, rb2, rb3, rb4, rb5, rb6, rb7, rb8, rb9, rb_remove;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        head = findViewById(R.id.textView15);
    ...
    public void onClick(View v){
        ...
        if(id == R.id.skipPas){
            ...
            if(flag){
                ...
                editor.apply();
                Intent mainIntent = new Intent(create_parol.this, create_card.class);
        ...
        if (id == R.id.rb1){
            ...
            switch (numberList.size()){
                case 1:
                    numberList.remove(0);
                    ind_1st.setImageResource(R.drawable.white_tochka_parol);
                    break;
                case 2:
                    numberList.remove(1);
                    ind_2nd.setImageResource(R.drawable.white_tochka_parol);
                    break;
                case 3:
                    numberList.remove(2);
                    ind_3rd.setImageResource(R.drawable.white_tochka_parol);
                    break;
                case 4:
                    numberList.remove(3);
                    ind_4th.setImageResource(R.drawable.white_tochka_parol);
                    break;
            }
            passNum(numberList);
        ...
        if (numberList.size() == 0){
            ...
            switch (numberList.size()){
                case 1:
                    ...
                    ind_1st.setImageResource(R.drawable.blue_tochka_parol);
                    break;
                case 2:
                    num2 = numberList.get(1);
                    ind_2nd.setImageResource(R.drawable.blue_tochka_parol);
                    break;
                case 3:
                    num3 = numberList.get(2);
                    ind_3rd.setImageResource(R.drawable.blue_tochka_parol);
                    break;
                case 4:
                    num4 = numberList.get(3);
                    ind_4th.setImageResource(R.drawable.blue_tochka_parol);
    ...
    private void matchPassCode() {
        if (getPassCode().equals(passCode)){
            ...
            if(!sp.contains(APP_PREFERENCES_CARD_FINISH)){
                ...
                startActivity(new Intent(this, MainAnalyz.class));
                this.finish();
            }
        }
        else {
    ...
    public void onSkip(View view){
        Intent intent = new Intent(this, create_card.class);
